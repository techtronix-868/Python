...
class Point :
    ...
    def distFrom(self, other):
        ...
        # using zip found over stackflow when to increment two x and y
        # had implemented two while loops but made the code complex
        squaredPart=[]
        for i,j in zip(self.coords, other.coords):
            squaredPart.append((i-j)**2)
        dist = math.sqrt(sum(squaredPart))
